...
class B1Main extends MY_Controller{
    public function __construct(){
        ...
        $this->_vars['url'] = URL::to('/')."/provider/";
    ...
    public function read(){
        ...
        $this->_vars['orderBy'] = ["id:asc"];
        $result['rows'] = ProviderType::query($this->_vars, ["mode"=>"rows"]);
        $result['total'] = ProviderType::query($this->_vars, ["mode"=>"total"]);
    ...
    public function create(Request $request){
        ...
        if ($validator->fails()){
            ...
            try{
                ...
                $insert['create_at'] = $at;
                DB::table('provider_type')->insert($insert);
    ...
    public function edit(Request $request, $id = 0){
        $this->_vars['id'] = $id;
        $sel = ProviderType::query($this->_vars, ["mode"=>"rowOne"]);
        if($sel['success']){
    ...
    public function update(Request $request, $id = 0){
        ...
        if ($validator->fails()){
            ...
            try{
                ...
                DB::table('provider_type')->where($where)->update($update);
    ...
    public function export(Request $request){
        $contentList = ProviderType::query($this->_vars, ["mode"=>"rowsAll"]);
        $fieldList = ProviderType::excelField();
    ...
    public function importTemplate(){
        $fieldList = ProviderType::importTemplateField();
