...
use App\Models\MCUFormatPackageItem;
...
class B4Main extends MY_Controller{
    ...
    public function read(){
        ...
        $resultNew2[0]['rowsChecked'] = MCUFormatPackageItem::query($this->_vars, ["mode"=>"rowsAll"]);
    ...
    public function packageItemUpdate(Request $request, $mcu_format_package_id = 0){
        ...
        $sel = MCUFormatPackage::query($qVars, ["mode"=>"rowOne"]);
        if($sel['success']){
            $validatorList = [
