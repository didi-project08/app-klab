...
<?php if(@$mode == 'add') { ?>
    <script>
        $eu(function(){
            $eu('#client_id').combobox({
                url:'{{$url}}readClientCombo?selectFirst=0',
            });
            $eu('#mcu2_format_id').combobox({
                url:'{{$url}}readMcu2FormatCombo?selectFirst=0',
            });
        })
    </script>
<?php } else if(@$mode == 'edit') { ?>
    <script>
        $eu(function(){
            $eu('#client_id').combobox({
                url:'{{$url}}readClientCombo?delete=-1&selectFirst=0',
            });
            $eu('#mcu2_format_id').combobox({
                url:'{{$url}}readMcu2FormatCombo?delete=-1&selectFirst=0',
            });
