...
Route::get('/'.$MAIN_URI."/label", [$CLASS, 'label']);
Route::get('/'.$MAIN_URI."/updateResult/{id?}", [$CLASS, 'updateResult']);
Route::put('/'.$MAIN_URI."/updateResultSave/{id?}", [$CLASS, 'updateResultSave']);
Route::get('/'.$MAIN_URI."/filter", [$CLASS, 'filter']);

Route::get('/'.$MAIN_URI."/patientImport/{id?}", [$CLASS, 'patientImport']);
Route::post('/'.$MAIN_URI."/patientImportSave/{id?}", [$CLASS, 'patientImportSave']);
Route::get('/'.$MAIN_URI."/patientImportTemplate", [$CLASS, 'patientImportTemplate']);
