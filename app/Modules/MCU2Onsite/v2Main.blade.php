    ...
    <div class="row p-3">
        <div class="col-12 col-md-8 mb-1">
            ...
            <?php if(1==1 || isset($userScope['roleAction']['/b2/create'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridAdd()"><i class="fas fa-add fa-lg"></i> Add</button>
            <?php } ?>
            ...
            <?php if(1==1 || isset($userScope['roleAction']['/b2/patientImport'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridImport()"><i class="far fa-file-excel fa-lg"></i> Imp. Patient</button>
            <?php } ?>
            |
            <?php if(1==1 || isset($userScope['roleAction']['/b2/patientExport'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridExport()"><i class="far fa-file-excel fa-lg"></i> Exp. Patient</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/patientImportUpdate'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridImportUpdate()"><i class="far fa-file-excel fa-lg"></i> Imp. Update Patient</button>
            <?php } ?>
        </div>
        ...
        <div class="col-12 col-md-12 mb-1">
            ...
            <?php if(1==1 || isset($userScope['roleAction']['/b2/presentSave'])) { ?>
                <button class="mb-1 btn btn-outline-warning" onclick="jf{{$_idb_}}dGridPresent()"><i class="far fa-calendar-check fa-lg"></i> Present</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/updateStatus'])) { ?>
                <button class="mb-1 btn btn-outline-warning" onclick="jf{{$_idb_}}dGridUpdateStatus()"><i class="far fa-calendar-check fa-lg"></i> Upd. Status</button>
            <?php } ?>
            |
            <?php if(1==1 || isset($userScope['roleAction']['/b2/Label'])) { ?>
                <select type="text" id="cp{{$_idb_}}dGridLabelConfCopy" style="width:100px; height:33px">
                    <?php for ($i=1; $i < 101; $i++) { ?>
                        <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                    <?php } ?>
                </select>
                <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridLabel('present_numFull')"><i class="fas fa-table fa-lg"></i> Label</button>
            <?php } ?>
            <?php if(1==2 || isset($userScope['roleAction']['/b2/CardControl'])) { ?>
                <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridCardControl()"><i class="fas fa-list-check fa-lg"></i> C. Control</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/conclusionGenerate'])) { ?>
                <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridGenerateConclusion()"><i class="fas fa-refresh fa-lg"></i> Re-Generate Conclusion</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/verify'])) { ?>
                <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridVerify()"><i class="fas fa-check-double fa-lg"></i> Verify</button>
            <?php } ?>
        </div>
        <div class="col-12 col-md-12">
            <select type="text" id="cp{{$_idb_}}dGridItemLv0"></select>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/resultImportSave'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridUpdateResult()"><i class="fa-solid fa-clipboard-check fa-lg"></i> Upd. Result</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/resultExport'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridExportResult()"><i class="far fa-file-excel fa-lg"></i> Exp. Result</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/resultImportSave'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridImportResult()"><i class="far fa-file-excel fa-lg"></i> Imp. Result</button>
            <?php } ?>
            |
            <?php if(1==1 || isset($userScope['roleAction']['/b2/resultPrint'])) { ?>
                <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridPrintResult()"><i class="far fa-file-pdf fa-lg"></i> Print</button>
            <?php } ?>
        </div>
        <div class="col-12 col-md-12">
            <?php if(1 == 2) { ?>
                ...
                <?php if(1==1 || isset($userScope['roleAction']['/b2/printLabel'])) { ?>
                    <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridLabel(4, '110x52-2')"><i class="fas fa-print fa-lg"></i> Print Label</button>
                <?php } ?>
                <?php if(1==1 || isset($userScope['roleAction']['/b2/printCover'])) { ?>
                    <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridPrintCover('PT GAM')"><i class="fas fa-print fa-lg"></i> Print Cover (A)</button>
                <?php } ?>
                <?php if(1==1 || isset($userScope['roleAction']['/b2/printCover'])) { ?>
                    <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridPrintCover('PT MGE')"><i class="fas fa-print fa-lg"></i> Print Cover (B)</button>
                <?php } ?>
            <?php } ?>
        </div>
    </div>
...
<script>
    ...
    function jf{{$_idb_}}dGridItemLv0(){
        var sel = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(sel){
            $eu("#cp{{$_idb_}}dGridItemLv0").combobox({
                url:"{{ $urlb }}mcuItemLv0Combo/"+sel.mcu2_format_id+"?selectFirst=1"
            })
        }
    }
    ...
    function jf{{$_idb_}}dGridUpdateStatus(){
        let sel = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(sel){
            let sel2 = $eu("#cp{{$_idb_}}dGrid").datagrid('getSelected');
            if(sel2){
                let cpModalId = "cpModal{{$_idb_}}DGridForm";
                let cpModalUrl = "{{$urlb}}updateStatus/"+sel2.id;
                cpGlobalModal(cpModalId, cpModalUrl);
                var cpModal = new bootstrap.Modal(document.getElementById(cpModalId), {backdrop:'static'});
                cpModal.show();
            }else{
    ...
    function jf{{$_idb_}}dGridLabel(confField="id", confSize="110x52-2"){
        let selEvent = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(selEvent){
            let sel = $eu("#cp{{$_idb_}}dGrid").datagrid('getSelected');
            ...
            if(patientIdList.length > 0){
                ...
                var confCopy = $("#cp{{$_idb_}}dGridLabelConfCopy").val();
                jf{{$_idb_}}dGridLabelGo(confField, confSize, confCopy, confEventId, patientIdList);
            }else{
                Swal.fire({
                    width:'300px',
                    icon: 'error',
    ...
    function jf{{$_idb_}}dGridLabelGo(confField, confSize, confCopy, confEventId, patientIdList){
        if(patientIdList.length > 0){
            let cpModalUrl = "{{$urlb}}label";
        ...
        //     let sel2 = $eu("#cp{{$_idb_}}dGrid").datagrid('getSelected');
        //     if(sel2){
        //         confCopy = $("#cp{{$_idb_}}dGridLabelConfCopy").val();
        //         let cpModalUrl = "{{$urlb}}label/"+sel2.id;
        //         cpModalUrl = cpModalUrl+"?confCopy="+confCopy;
        //         cpModalUrl = cpModalUrl+"&confSize="+confSize;
        //         window.open(cpModalUrl)
        //     }else{
    ...
    function jf{{$_idb_}}dGridPrintCover(corpName = ""){
        let sel = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(sel){
            let sel2 = $eu("#cp{{$_idb_}}dGrid").datagrid('getChecked');
            if(sel2.length > 0){
                let idList = [];
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url:"{{ $urlb }}printCover?corpName="+corpName,
                    data:{
                        "_token": "{{ csrf_token() }}",
                        idList:idList
                    },
    ...
    function jf{{$_idb_}}dGridPrintResult(){
        let selEvent = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(selEvent){
            let sel = $eu("#cp{{$_idb_}}dGrid").datagrid('getSelected');
            let checked = $eu("#cp{{$_idb_}}dGrid").datagrid('getChecked');
            ...
            if(patientIdList.length > 0){
                ...
                window.open("{{ $urlb }}resultPrint?"+filterParams);
            }else{
                Swal.fire({
                    width:'300px',
                    icon: 'error',
    ...
    function jf{{$_idb_}}dGridVerifyGo(){
        let selEvent = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(selEvent){
            let sel = $eu("#cp{{$_idb_}}dGrid").datagrid('getSelected');
            let checked = $eu("#cp{{$_idb_}}dGrid").datagrid('getChecked');
    ...
    function jf{{$_idb_}}dGridGenerateConclusion(){
        let selEvent = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(selEvent){
            let sel = $eu("#cp{{$_idb_}}dGrid").datagrid('getSelected');
            let checked = $eu("#cp{{$_idb_}}dGrid").datagrid('getChecked');
            ...
            if(patientIdList.length > 0){
                var resultCate = $eu("#cp{{$_idb_}}dGridItemLv0").combobox('getValue');
                var filterParams = "mcu_event_id="+selEvent.id+"&patientIdList="+patientIdList+"&resultCate="+resultCate;
                window.open("{{ $urlb }}conclusionGenerate?"+filterParams);
            }else{
                Swal.fire({
                    width:'300px',
                    icon: 'error',
    ...
    function jf{{$_idb_}}dGridImport(){
        let sel = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(sel){
            let cpModalId = "cpModal{{$_idb_}}DGridFormImport";
            let cpModalUrl = "{{$urlb}}patientImport/"+sel.id;
            cpGlobalModal(cpModalId, cpModalUrl);
            var cpModal = new bootstrap.Modal(document.getElementById(cpModalId), {backdrop:'static'});
            cpModal.show();
        }else{
    ...
    function jf{{$_idb_}}dGridUpdateResult(){
        ...
        if(sel){
            ...
            if(sel2){
                ...
                if(resultCate){
                    let cpModalId = "cpModal{{$_idb_}}DGridForm";
                    let cpModalUrl = "{{$urlb}}updateResult/"+sel2.id+"?resultCate="+resultCate;
                    cpGlobalModal(cpModalId, cpModalUrl);
                    var cpModal = new bootstrap.Modal(document.getElementById(cpModalId), {backdrop:'static'});
                    cpModal.show();
                }else{
