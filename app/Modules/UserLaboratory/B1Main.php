...
use App\Models\UserAccountLaboratory;
...
class B1Main extends MY_Controller{
    ...
    public function read(){
        $qVars['delete'] = -1;
        $this->_vars['userLaboratory'] = ModelBase::userLaboratory($qVars);
        $result['rows'] = UserAccountLaboratory::query($this->_vars, ["mode"=>"rows"]);
        $result['total'] = UserAccountLaboratory::query($this->_vars, ["mode"=>"total"]);
    ...
    public function create(Request $request){
        ...
        if ($validator->fails()){
            ...
            try{
                ...
                $insert['laboratory_id'] = $request->all()['laboratory_id'];
                DB::table('user_laboratory')->insert($insert);
    ...
    public function edit(Request $request, $id = 0){
        ...
        $sel = UserAccountLaboratory::query($this->_vars, ["mode"=>"rowOne"]);
        if($sel['success']){
