...
class B3Main extends MY_Controller{
    ...
    public function read(){
        ...
        $result['rows'] = RoleAccountLaboratory::query($this->_vars, ["mode"=>"rows"]);
        $result['total'] = RoleAccountLaboratory::query($this->_vars, ["mode"=>"total"]);
        echo json_encode($result);
    }
    public function add(){
    ...
    public function create(Request $request){
        ...
        if ($validator->fails()){
            ...
            try{
                ...
                DB::table('role_laboratory')->insert($insert);
    ...
    public function edit(Request $request, $id = 0){
        ...
        $sel = RoleAccountLaboratory::query($this->_vars, ["mode"=>"rowOne"]);
        if($sel['success']){
