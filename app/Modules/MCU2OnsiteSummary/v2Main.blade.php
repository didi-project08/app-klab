    ...
    <div class="row p-3">
        ...
        <div class="col-12 col-md-12 mb-1">
            ...
            <?php if(1==1 || isset($userScope['roleAction']['/b2/Label'])) { ?>
                <button class="mb-1 btn btn-outline-danger" onclick="jf{{$_idb_}}dGridLabel()"><i class="fas fa-table fa-lg"></i> Label</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/CardControl'])) { ?>
...
<script>
    ...
    function jf{{$_idb_}}dGridLabel(confCopy=4, confSize="110x52-2"){
        let sel = $eu("#cp{{$_id_}}b1dGrid").datagrid('getSelected');
        if(sel){
            let sel2 = $eu("#cp{{$_idb_}}dGrid").datagrid('getSelected');
            if(sel2){
