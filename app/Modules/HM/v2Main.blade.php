    ...
    <div class="row p-3">
        <div class="col-12 col-md-12">
            ...
            <?php if(1==1 || isset($userScope['roleAction']['/b2/presentSave'])) { ?>
                <button class="mb-1 btn btn-outline-warning" onclick="jf{{$_idb_}}dGridPresent()"><i class="far fa-calendar-check fa-lg"></i> Update Status</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/b2/patientExport'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf{{$_idb_}}dGridExport()"><i class="far fa-file-excel fa-lg"></i> Export</button>
            <?php } ?>
        </div>
    ...
    $eu(function(){
        $eu("#cp{{$_idb_}}dGrid").datagrid({
            ...
            columns: [[
                ...
                {field: "actual_date_dmY_slash",title: "<b>MCU Date</b>",align: "center",width: 100},
