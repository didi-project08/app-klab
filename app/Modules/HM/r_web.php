...
use App\Modules\HM\Main;
use App\Modules\HM\B1Main;
use App\Modules\HM\B2Main;
use App\Modules\HM\B3Main;
...
$MAIN_URI = "hm/b1";
$CLASS = B1Main::class;
Route::get('/'.$MAIN_URI."/sample/{id?}", [$CLASS, 'sample']);
Route::get('/'.$MAIN_URI."/read/{id?}", [$CLASS, 'read']);
