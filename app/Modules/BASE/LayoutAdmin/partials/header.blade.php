<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      ...
      <a href="{{$base_url}}">
        <h4 class="d-none d-sm-block"><b>{{ env('APP_NAME') }}</b></h4>
        <h5 class="d-block d-sm-none"><b>{{ env('APP_NAME') }}</b></h5>
      </a>
    ...
    <div class="left-menu-header col" style="padding-bottom:0px; padding-top:8px">
      ...
      @yield('headerBreadcrumb')
    </div>
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menus">
        <li><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()"><i data-feather="maximize"></i></a></li>
        <li class="onhover-dropdown p-0">
          <a class="btn btn-primary-light" type="button" href="{{$base_url}}logout"><i data-feather="log-out"></i>Log out</a>
        </li>
      </ul>
    </div>
