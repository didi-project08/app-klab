...
<cpModalFooter>
    ...
    <button class="btn btn-outline-primary" type="button" onclick="jf{{$_id_}}dGridSave()">Submit</button>
</cpModalFooter>

<div id="cp{{$_id_}}dGridFormImportContent">
    <form id="cp{{$_id_}}dGridFormImport" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12 col-md-12 mb-3">
                <div style="float:right">
                    <a class="btn btn-outline-success" href="{{$url}}importTemplate" target="_blank"><i class="fas fa-file-excel fa-fw"></i>Download Template</a>
                </div>
            </div>
            <div class="col-12 col-md-12 mb-3">
                <input class="" type="text" id="cp{{$_id_}}file" name="file" style="width:100%">
...
<script>
    ...
    function jf{{$_id_}}dGridSave(){
        ...
        $eu("#cp{{$_id_}}dGridFormImport").form("submit", {
            url: "{{ @$url_save }}",
            onSubmit: function() {
