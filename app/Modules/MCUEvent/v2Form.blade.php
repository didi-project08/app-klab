    ...
    <form id="cp{{$_idb_}}dGridFormMain" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <?php if(isset($userScope['roleAction']['/b2/--showPriceLab'])) { ?>
                <div class="col-12 col-md-6 mb-3">
                    <input class="" id="price_lab" name="price_lab" style="width:100%; text-align:right">
                    <div id="price_lab_error" class='form_error'></div>
                </div>
            <?php } ?>
            <?php if(isset($userScope['roleAction']['/b2/--showPriceCorporate'])) { ?>
                <div class="col-12 col-md-6 mb-3">
                    <input class="" id="price_corporate" name="price_corporate" style="width:100%; text-align:right">
...
<script>
    $eu(function(){
        ...
        $eu("#corporate_emp_id").combogrid({
            ...
            onHidePanel:function(){
                ...
                if(sel){
                    preloader_block()
                    setTimeout(() => {
                        $eu("#cp{{$_idb_}}dGridFormMain").form('load', sel);
                        preloader_none();
                    }, 500);
                }
            }
        ...
        $eu('#status').combobox({
            ...
            panelHeight:'auto',
            data:[
                {id:'sFinished',title:"Finish", selected:true},
                {id:'sPresented',title:"Not Finish"},
            ]
        });
        $eu('#fit_date').datebox({
            required:false,
...
<?php if(@$mode == 'add') { ?>
    ...
    <script>
        $(function(){
            ...
            $eu("#mcu_format_package_id").combobox({url:'{{$urlb}}readFormatPackageCombo?mcu_format_id={{$eventData->mcu_format_id}}'});
            setTimeout(() => {
