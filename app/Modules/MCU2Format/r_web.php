...
use App\Modules\MCU2Format\Main;
use App\Modules\MCU2Format\B1Main;
use App\Modules\MCU2Format\B2Main;
use App\Modules\MCU2Format\B3Main;
use App\Modules\MCU2Format\B4Main;
use App\Modules\MCU2Format\B5Main;

$MAIN_URI = "mcu2-format";
$CLASS = Main::class;
Route::get('/'.$MAIN_URI, [$CLASS, 'index']);

$MAIN_URI = "mcu2-format/b1";
$CLASS = B1Main::class;
...
$MAIN_URI = "mcu2-format";
$MAIN_URI1 = "mcu2-format/b1";
$MAIN_URI2 = "mcu2-format/b2";
$MAIN_URI3 = "mcu2-format/b3";
$MAIN_URI4 = "mcu2-format/b3";
$CLASS = Main::class;
$CLASS1 = B1Main::class;
$CLASS2 = B2Main::class;
$CLASS3 = B3Main::class;
