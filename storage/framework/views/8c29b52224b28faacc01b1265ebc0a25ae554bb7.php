...
<div id="cp<?php echo e($_idbf_); ?>dGridFormContent">
    <form id="cp<?php echo e($_idbf_); ?>dGridForm" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 mb-3">
                <input class="form-controls" type="text" id="i<?php echo e($_idbf_); ?>f_role_name" name="f_role_name" style="width:100%">
...
<script>
    $eu(function(){
        ...
        $eu('#i<?php echo e($_idbf_); ?>f_role_name').textbox({
            required:true,
            label:"Role Name",
            labelPosition:'top',
            prompt:"Role Name"
...
<?php } ?><?php /**PATH /home/n1731643/public_sys/devapp-mcu/app/Modules/UserLaboratory/v3Form.blade.php ENDPATH**/ ?>