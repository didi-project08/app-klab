        ...
        <div class="row">
            ...
            <?php if($GLOBALS['II_INDEX'] >= 0 ) { ?>
                ...
                <div class="col-12 col-md-6 mb-2">
                    ...
                    <input class="" type="hidden" name="iiData[<?php echo e($GLOBALS['II_INDEX']); ?>][input_type]" value="TEXT" style="width:100%">
                    <input class="" type="hidden" name="iiData[<?php echo e($GLOBALS['II_INDEX']); ?>][input_image_folder]" value="" style="width:100%">
        ...
        <?php foreach ($formatItem as $k => $v) { ?>
            <?php if($v->header == 0 && $v->input_type != "FUNCTION") { ?>
                ...
                <?php } else if($v->input_type == "IMAGE") { ?>
                    ...
                    $('#<?php echo e($iiID); ?>_file_exist').text("Exist : <?php echo @$resultData[$v->code]; ?>");
                <?php } ?>
            <?php } ?>
        <?php } ?>
...
<?php } ?><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCU2Onsite/v2FormResult.blade.php ENDPATH**/ ?>