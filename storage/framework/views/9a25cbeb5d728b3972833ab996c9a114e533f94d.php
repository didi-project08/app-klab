        ...
        <div data-options="region:'south', border:false" class="p-2" style="height:60%">
            ...
            <div data-options="title:'MCU PACKAGE', border:true" style="padding:10px">
                <div class="easyui-layout" data-options="fit:true">
                    ...
                    <div data-options="region:'east', title:'Package Item', split:true, hideCollapsedContent:true, border:false, href:'<?php echo e($url); ?>b4/index'" class="p-2" style="width:50%"></div>
                </div>
            </div>
            <div data-options="title:'MCU TEAM', border:true, href:'<?php echo e($url); ?>b5/index'" style="padding:10px"></div>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BASE.LayoutAdmin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCU2Format/vMain.blade.php ENDPATH**/ ?>