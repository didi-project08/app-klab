    ...
    <form id="cp<?php echo e($_idbf_); ?>dGridForm" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-12 col-md-12 mb-3">
                <select class="" id="i<?php echo e($_idbf_); ?>laboratory_id" name="laboratory_id" style="width:100%"></select>
...
<script>
    $eu(function(){
        $eu('#i<?php echo e($_idbf_); ?>laboratory_id').combobox({
            required:true,
            label:"Provider",
            labelPosition:'top',
        ...
        setTimeout(() => {
            $eu('#i<?php echo e($_idbf_); ?>f_fullname').textbox('textbox').focus();
        }, 500);
...
<?php if(@$mode == 'add') { ?>
    <script>
        $eu(function(){
            $eu('#i<?php echo e($_idbf_); ?>laboratory_id').combobox({
                url:'<?php echo e($urlb); ?>readLaboratoryCombo?selectFirst=1',
                onChange:function(newValue,oldValue){
                    $eu('#i<?php echo e($_idbf_); ?>f_role_id').combobox('reload','<?php echo e($urlb); ?>readRoleCombo?laboratory_id='+newValue);
                }
            });
            $eu('#i<?php echo e($_idbf_); ?>f_role_id').combobox({
                onLoadSuccess:function(){
                    $eu('#i<?php echo e($_idbf_); ?>f_role_id').combobox('setValue','');
                }
            });
        })
    </script>
<?php } else if(@$mode == 'edit') { ?>
    <script>
        $eu(function(){
            ...
            $eu('#i<?php echo e($_idbf_); ?>laboratory_id').combobox('disable',true);
...
<?php } ?><?php /**PATH /home/u1598413/public_sys/devapp-mcu/app/Modules/UserLaboratory/v1Form.blade.php ENDPATH**/ ?>