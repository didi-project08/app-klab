<div id="cp<?php echo e($_idb_); ?>dGridToolbar">
    <div class="row p-3">
        <div class="col-12 col-md-8">
            ...
            <!-- <button class="mb-1 btn btn-outline-secondary" onclick="jf<?php echo e($_idb_); ?>dGridPatientList()"><i class="fas fa-list fa-lg"></i> Patient List</button> -->
        </div>
    ...
    $eu(function(){
        $eu("#cp<?php echo e($_idb_); ?>dGrid").datagrid({
            ...
            columns: [[
                ...
                {field: "eventnum",title: "<b>Event</b>",align: "center",width: 85},
                {field: "status",title: "<b>Status</b>",align: "center",width: 100},
                {field: "status_at",title: "<b>Status Date</b>",align: "center",width: 100},
                // {field: "corporate_name",title: "<b>Corporate</b>",align: "left",width: 200},
                {field: "emp_no",title: "<b>Emp. Number</b>",align: "center",width: 120},
                {field: "nik",title: "<b>ID (NIK / Passport)</b>",align: "center",width: 140},
    ...
    function jf<?php echo e($_idb_); ?>dGridPatientList(){
        ...
        if(sel){
            ...
            Swal.fire({
                ...
                icon: 'error',
                title: 'Oops...',
                text: 'Please select one MCU Event to Show Patient List',
...
</script><?php /**PATH C:\Users\Lenovo\Documents\Envato\viho_all\Viho-Laravel-8\theme\app\Modules/MCUEvent/v3Main.blade.php ENDPATH**/ ?>