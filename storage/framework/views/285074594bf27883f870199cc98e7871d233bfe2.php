...
<form id="cp<?php echo e($_idb_); ?>dGridFilterForm" method="get" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-12 col-md-12 mb-3">
            <input class="form-controls" type="text" id="cp<?php echo e($_idb_); ?>dGridFilterScheduleDate" name="schedule_date" style="width:100%">
        </div>
        <div class="col-12 col-md-12 mb-3">
            <input class="form-controls" type="text" id="cp<?php echo e($_idb_); ?>dGridFilterStatus" name="status" style="width:100%">
        </div>
    </div>
</form>
...
<script>
    $eu(function(){
        ...
        $eu('#cp<?php echo e($_idb_); ?>dGridFilterScheduleDate').datebox({
            required:false,
            label:"MCU Schedule",
            labelPosition:'top',
            prompt:"dd/mm/yyyy",
        ...
        $eu('#cp<?php echo e($_idb_); ?>dGridFilterStatus').combobox({
            required:true,
            label:"Status",
            labelPosition:'top',
        ...
        $eu('#cp<?php echo e($_idb_); ?>dGridFilterStatus').combobox('setValue','sAll');

        jf<?php echo e($_idb_); ?>dGridFilter_p();
    })
</script><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCU2Onsite/v2Filter.blade.php ENDPATH**/ ?>