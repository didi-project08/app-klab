    ...
    <div class="row p-3">
        <div class="col-12">
            <?php if(1==1 || isset($userScope['roleAction']['/create'])) { ?>
                <button class="mb-1 btn btn-outline-primary" onclick="jf<?php echo e($_idb_); ?>dGridAdd()"><i class="fas fa-add fa-fw"></i> Add</button>
            <?php } ?>
            <?php if(1==1 || isset($userScope['roleAction']['/create'])) { ?>
...
</script><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCU2Format/v5Main.blade.php ENDPATH**/ ?>