            ...
            <div class="easyui-tabs" data-options="fit:true, border:true, tabPosition:'top'">
                ...
                <div data-options="title:'Role Configuration', border:true" style="padding:10px">
                    <div class="easyui-layout" data-options="fit:true">
                        ...
                        <div data-options="region:'south', title:'Package Item', split:true, hideCollapsedContent:false, border:false, href:'<?php echo e($url); ?>b4/index'" class="p-2" style="height:50%"></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BASE.LayoutAdmin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Documents\Envato\viho_all\Viho-Laravel-8\theme\app\Modules/UserCorporate/vMain.blade.php ENDPATH**/ ?>