...
<div id="cp<?php echo e($_idb_); ?>dGridFormContent">
    <form id="cp<?php echo e($_idb_); ?>dGridForm" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 mb-3">
                <input class="" type="text" id="drive_link" name="drive_link" style="width:100%">
                <div id="drive_link_error" class='form_error'></div>
            </div>
        </div>
    </form>
</div>
...
<script>
    $eu(function(){
        $eu('#owner').combobox({
            ...
            value:<?php echo e(($userScope['info']->f_user_admin == 1) ? 3 : $userScope['info']->f_user_type); ?>,
        ...
        $eu('#drive_link').textbox({
            required:false,
            label:"Google Drive URL",
            labelPosition:'top',
            prompt:"Google Drive URL",
        });
...
<?php } ?><?php /**PATH /home/u1598413/public_sys/devapp-mcu/app/Modules/MCUEvent/v1Form.blade.php ENDPATH**/ ?>