...
<script>
    ...
    function jf<?php echo e($_idb_); ?>dGridPackageItemUpdate(header = 0){
        let sel = $eu("#cp<?php echo e($_id_); ?>b3dGrid").datagrid('getSelected');
        if(sel){
...
</script><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCUFormat/v4Main.blade.php ENDPATH**/ ?>