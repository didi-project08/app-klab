...
<div id="cp<?php echo e($_idbf_); ?>dGridFormContent">
    <form id="cp<?php echo e($_idbf_); ?>dGridForm" method="post" enctype="multipart/form-data">
        ...
        <div style="height:300px">
            <table id="cp<?php echo e($_idbf_); ?>FormMovedGrid"></table>
        </div>
        <br>
        <div class="row">
            <div class="col-12 col-md-12 mb-3">
                <select class="" id="cp<?php echo e($_idbf_); ?>mcu_format_package_id" name="mcu_format_package_id" style="width:100%"></select>
...
<script>
    $eu(function(){
        $eu("#cp<?php echo e($_idbf_); ?>FormMovedGrid").datagrid({
            border:true,
            striped: true,
            pagination: true,
            fit: true,
            ...
            method: "GET",
            idField: "id",
            url: "<?php echo e($urlb); ?>readMCUEvent?corporate_id=<?php echo e($eventData->corporate_id); ?>",
            frozenColumns: [[
            ...
            onSelect:function(index,row){
                $eu("#cp<?php echo e($_idbf_); ?>mcu_format_package_id").combobox({url:'<?php echo e($urlb); ?>readFormatPackageCombo?mcu_format_id='+row.mcu_format_id});
            }
        })
        $eu('#cp<?php echo e($_idbf_); ?>mcu_format_package_id').combobox({
            required:true,
            label:"Pakcage",
            labelPosition:'top',
            ...
            onLoadSuccess:function(){
                $eu('#cp<?php echo e($_idbf_); ?>mcu_format_package_id').combobox('setValue','');
            }
        });
        euDoLayout();
    })
    ...
    function jf<?php echo e($_idbf_); ?>dGridSave(){
        let sel = $eu("#cp<?php echo e($_idbf_); ?>FormMovedGrid").datagrid('getSelected');
        if(sel){
...
<?php } ?><?php /**PATH /home/n1731643/public_sys/devapp-mcu/app/Modules/MCUEvent/v2FormMove.blade.php ENDPATH**/ ?>