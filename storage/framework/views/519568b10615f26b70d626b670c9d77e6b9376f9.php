...
<?php } else if(@$mode == 'edit') { ?>
    <script>
        $(function(){
            $eu('#corporate_id').combobox("reload",'<?php echo e($url); ?>readCorporateCombo');
...
<?php } ?><?php /**PATH C:\Users\Lenovo\Documents\Envato\viho_all\Viho-Laravel-8\theme\app\Modules/CorporateEmp/vForm.blade.php ENDPATH**/ ?>