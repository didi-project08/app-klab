...
<div id="cp<?php echo e($_idbf_); ?>dGridFormContent">
    <form id="cp<?php echo e($_idbf_); ?>dGridForm" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 d-none" id="i<?php echo e($_idbf_); ?>input_image_folder_frame">
                <input class="form-controls" type="text" id="i<?php echo e($_idbf_); ?>input_image_folder" name="input_image_folder" style="width:100%">
            </div>
    ...
    $eu(function(){
        ...
        $eu('#i<?php echo e($_idbf_); ?>input_type').combobox({
            ...
            onChange:function(newValue, oldValue){
                ...
                $('#i<?php echo e($_idbf_); ?>input_image_folder_frame').addClass('d-none');
                ...
                $eu('#i<?php echo e($_idbf_); ?>input_image_folder').textbox({ required:false });
                ...
                if(newValue == "TEXT"){
                    ...
                    $('#i<?php echo e($_idbf_); ?>input_image_folder_frame').removeClass('d-none');
                    $eu('#i<?php echo e($_idbf_); ?>input_image_folder').textbox({ required:true });
                }
                euDoLayout();
            }
        })
        ...
        $eu('#i<?php echo e($_idbf_); ?>input_image_folder').textbox({
            required:false,
            label:"Image Folder",
            labelPosition:'top',
            prompt:"Image Folder"
...
<?php } ?><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCU2Format/v2FormInput.blade.php ENDPATH**/ ?>