...
<div id="cp<?php echo e($_idb_); ?>dGridFormImportResultContent">
    <form id="cp<?php echo e($_idb_); ?>dGridFormImportResult" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
...
<script>
    ...
    function jf<?php echo e($_idb_); ?>dGridSave(){
        ...
        $eu("#cp<?php echo e($_idb_); ?>dGridFormImportResult").form("submit", {
...
<?php } else { ?>
    <script>
        $(function(){
            $("#cp<?php echo e($_idb_); ?>dGridFormImportResultContent").html("Request not valid.");
        })
    </script>
<?php } ?><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCU2Onsite/v2FormImportResult.blade.php ENDPATH**/ ?>