...
<div id="cp<?php echo e($_idb_); ?>dGridFormConfirmContent">
    <form id="cp<?php echo e($_idb_); ?>dGridFormConfirm" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<script>
    ...
    function jf<?php echo e($_idb_); ?>dGridSave(){
        preloader_block();
        $eu("#cp<?php echo e($_idb_); ?>dGridFormConfirm").form("submit", {
...
</script><?php /**PATH /home/u1598413/public_sys/devapp-mcu/app/Modules/MCUOnsiteEvent/v1FormConfirm.blade.php ENDPATH**/ ?>