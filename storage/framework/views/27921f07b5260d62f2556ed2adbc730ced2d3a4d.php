    ...
    <form id="cp<?php echo e($_idb_); ?>dGridFormMain" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-12 col-md-12 mb-3">
                ...
                <div style="color:blue"><i><small>* You Can Use (KTP / Passport / Empoyee Number)</small></i></div>
...
<script>
    $eu(function(){
        ...
        $eu('#mcu2_format_package_code').combobox({
            ...
            method: "GET",
            // url:'<?php echo e($urlb); ?>readMcu2FormatPackageCombo',
            editable:false,
            valueField:'code',
            textField:'title_mod',
            panelHeight:150
...
<?php if(@$mode == 'add') { ?>
    ...
    <script>
        $(function(){
            $eu('#mcu2_format_package_code').combobox({
                url:'<?php echo e($url); ?>readMcu2FormatPackageComboo?selectFirst=0&mcu_format_id=<?php echo e($eventData->mcu2_format_id); ?>',
            });
            setTimeout(() => {
...
<?php } ?><?php /**PATH /home/u1598413/public_sys/devapp-mcu/app/Modules/MCU2Onsite/v2Form.blade.php ENDPATH**/ ?>