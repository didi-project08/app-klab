...
<script>
    $eu(function(){
        $eu("#cp<?php echo e($_idb_); ?>dGrid").datagrid({
            ...
            columns: [[
                {field: "eventFinish",title: "<b>A/F</b>",align: "center",width: 30,
                    styler: function(value,row,index){
                        return 'background-color:'+row.eventFinishColor+';color:white;';
                    }
                },
                {field: "eventnum",title: "<b>Number</b>",align: "center",width: 80},
                {field: "title",title: "<b>Event Title</b>",align: "left",width: 250},
                {field: "client_name",title: "<b>Client</b>",align: "left",width: 250},
                ...
                {field: "mcu2_format_name",title: "<b>Format</b>",align: "left",width: 200},
                {field: "desc",title: "<b>Description</b>",align: "left",width: 300},
            ...
            onSelect:function(index,row){
                ...
                if(typeof jf<?php echo e($_id_); ?>b2dGridItemLv0 === "function"){
                    jf<?php echo e($_id_); ?>b2dGridItemLv0();
                }
            }
        })
...
</script><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/MCU2Onsite/v1Main.blade.php ENDPATH**/ ?>