...
<script>
    $eu(function(){
        $eu("#cp<?php echo e($_idb_); ?>dGrid").datagrid({
            ...
            columns: [[
                {field: "laboratory_name",title: "<b>Provider</b>",align: "left",width: 175},
    ...
    function jf<?php echo e($_idb_); ?>dGridEdit(){
        ...
        if(sel){
            let cpModalId = "cpModal<?php echo e($_idb_); ?>DGridForm";
            let cpModalUrl = "<?php echo e($urlb); ?>edit/"+sel.f_user_id;
            cpGlobalModal(cpModalId, cpModalUrl);
            var cpModal = new bootstrap.Modal(document.getElementById(cpModalId), {backdrop:'static'});
            cpModal.show();
        }else{
    ...
    function jf<?php echo e($_idb_); ?>dGridDeleteGo(){
        ...
        $.ajax({
            type: 'DELETE',
            dataType: "JSON",
            url:"<?php echo e($urlb); ?>delete/"+sel.f_user_id,
            data:{
...
</script><?php /**PATH /home/u1598413/public_sys/devapp-mcu/app/Modules/UserLaboratory/v1Main.blade.php ENDPATH**/ ?>