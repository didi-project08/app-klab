...
<?php $__env->startSection('headerBreadcrumb'); ?>
	...
	<?php $__env->startComponent('BASE.LayoutAdmin.breadcrumb'); ?>
		<?php $__env->slot('breadcrumb_title'); ?>
            <h4 class="d-none d-sm-block">User Master</h4>
			<h5 class="d-block d-sm-none">User Master</h5>
		<?php $__env->endSlot(); ?>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center', border:false" class="p-2">
            <div class="easyui-tabs" data-options="fit:true, border:true, tabPosition:'top'">
                <div data-options="title:'User Master', border:true, href:'<?php echo e($url); ?>b1/index'" style="padding:10px">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BASE.LayoutAdmin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1598413/public_sys/dkdmcu_klab__dev/app/Modules/UserMaster/vMain.blade.php ENDPATH**/ ?>