<?php if(@$mode == 'add') { ?>
    ...
    <cpModalFooter>
        ...
        <button class="btn btn-outline-primary" type="button" onclick="jf<?php echo e($_idb_); ?>dGridSave(1)">Submit & Create New</button>
    </cpModalFooter>
...
<script>
    ...
    function jf<?php echo e($_idb_); ?>dGridSave(createNew = 0){
        preloader_block();
...
<?php } ?><?php /**PATH C:\Users\Lenovo\Documents\Envato\viho_all\Viho-Laravel-8\theme\app\Modules/MCUFormat/v3Form.blade.php ENDPATH**/ ?>